                ...
                <>
                  ...
                  {selectedBooking.status !== "APPROVED" && (
                    <button 
                      ...
                      disabled={deleting}
                      className="flex-1 py-4 bg-rose-50 text-rose-600 rounded-2xl font-black text-sm hover:bg-rose-100 transition-all active:scale-95 flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                  ...
                  <button 
                    ...
                    className="flex-1 py-4 bg-indigo-50 text-indigo-600 rounded-2xl font-black text-sm hover:bg-indigo-100 transition-all active:scale-95"
                  >
                    DISMISS
                  </button>
                </>
