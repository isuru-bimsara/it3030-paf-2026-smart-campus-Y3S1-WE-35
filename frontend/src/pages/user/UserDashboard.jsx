...
export default function UserDashboard() {
  ...
  const heroResource = useMemo(
    () =>
      resources.find((resource) => imageUrlFor(resource)) ||
      resources[0] ||
      null,
    [resources],
  );
  ...
  const statusMix = useMemo(
    () => [
      {
        name: "Approved",
        total: bookings.filter((booking) => booking.status === "APPROVED")
          .length,
      },
      {
        name: "Pending",
        total: bookings.filter((booking) => booking.status === "PENDING")
          .length,
      },
      {
        name: "Open",
        total: tickets.filter((ticketItem) => ticketItem.status === "OPEN")
          .length,
      },
      {
        name: "Active",
        total: tickets.filter(
          (ticketItem) => ticketItem.status === "IN_PROGRESS",
        ).length,
      },
    ],
    [bookings, tickets],
  ...
  const statCards = [
    {
      ...
      detail: bookingApprovalRate
        ? `${bookingApprovalRate}% approval rate`
        : "No approvals yet",
      icon: CalendarClock,
    },
    {
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600 md:text-lg">
                Monitor reservations, support requests, and open campus
                resources from a single elegant workspace built for speed,
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              >
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Track every reservation and approval.
                </p>
              </button>
              ...
              >
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Report issues without leaving the flow.
                </p>
              </button>
            </div>
          </div>
